...
- **Speed:** All 30 prompts processed in under 2 minutes on T4 GPU
...
- Tested null cases (weather, jokes, capital cities) to verify the model
  correctly returns `null` when no function matches.
